...
| `T2_CODEX_IMPLEMENTER` | Scoped code/config worker | code, config, YAML, shell-script changes inside assigned repo/scope/branch | production runtime mutation unless separate runtime profile is granted | tests, diff review, secret scan, PR, receipt |
