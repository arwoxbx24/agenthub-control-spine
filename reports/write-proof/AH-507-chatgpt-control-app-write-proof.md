...
- The MCP tool `github_write_proof` exists in the prototype, but live write proof is blocked until ChatGPT Developer Mode, public HTTPS `/mcp`, and server-side GitHub credentials are configured.
