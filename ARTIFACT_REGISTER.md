...
| `reports/devops/komodo-orchestration-roadmap-20260526.md` | `audit_only` | false | false | AH-571 | Komodo/NPM/Portainer orchestration architecture report; source-grounded planning only, not live rollout evidence. |
| `reports/devops/komodo-orchestration-task-decomposition-20260526.md` | `active_control` | false | false | AH-571 | Bounded implementation backlog and review checklist for future AgentHub live DevOps tasks. |
...
| `reports/receipts/RUN-komodo-orchestration-20260526-receipt.md` | `operational_receipt` | false | false | AH-571 | Receipt for Komodo orchestration report, task creation, and repository package. |
...
| `reports/receipts/AGENTHUB-P0-break-glass-safe-route-recovery-final-receipt-20260525.md` | `operational_receipt` | false | false | AH-567/AH-536/AH-554 | Final receipt for break-glass route; T2 and verifier ran, public 502 remains, blocker `EDGE_NPM_AUTH_REQUIRED`. |
| `reports/incidents/AGENTHUB-P0-break-glass-safe-route-recovery-report-20260525.md` | `audit_only` | false | false | AH-567/AH-536/AH-554 | Detailed break-glass route recovery report, Five Whys, self-critique, evidence ledger, and final `EDGE_NPM_AUTH_REQUIRED` blocker. |
| `reports/receipts/AGENTHUB-P0-npm-api-only-route-recovery-start-receipt-20260525.md` | `operational_receipt` | false | false | AH-567/AH-536/AH-554 | Start receipt for owner-clarified NPM API-only route; direct NPM UI/files/container access forbidden. |
