...
| `reports/receipts/AGENTHUB-P0-repo-first-agent-execution-freeze-receipt-20260525.md` | `operational_receipt` | false | false | AH-567/AH-536/AH-554 | Emergency intake receipt before any further runtime mutation; blocks on `AGENTHUB_LIVE_WORKER_ROUTE_BLOCKED`. |
| `governance/agenthub-controlled-live-devops-permission-profile-ah536-ah554-ah567.md` | `active_control` | false | false | AH-567/AH-536/AH-554 | Narrow controlled-unfreeze permission profile; remaps live-route loop to `AGENTHUB_PERMISSION_AUTH_REQUIRED` unless accepted T2 route exists. |
...
| `reports/receipts/AGENTHUB-P0-controlled-unfreeze-safe-permission-expansion-receipt-20260525.md` | `operational_receipt` | false | false | AH-567/AH-536/AH-554 | Controlled-unfreeze receipt; profile recorded and runtime continuation blocked on `AGENTHUB_PERMISSION_AUTH_REQUIRED`. |
