...
|---|---|---|---|---|---|---|---|---|
| `#35` | `AH-530` / `AH-531` / `AH-532` | `RUN-external-pattern-adaptation-closure-20260524` | `agenthub/external-pattern-adaptation-closure-20260524` | T0 Registrar | `MERGE_READY` | Adaptation readiness package from AH-527 research: roadmap, Anthropic worker brief, Microsoft worker brief, and receipt. Merge only after required checks pass. | `governance/external-repo-pattern-adaptation-roadmap.md`; `prompts/implementation/anthropic-knowledge-work-pattern-adaptation-worker.txt`; `prompts/implementation/microsoft-ai-engineering-coach-pattern-adaptation-worker.txt`; `reports/receipts/external-repo-pattern-adaptation-closed-loop-receipt.md` | none |
...
| PR | Decision | Blocker |
|---|---|---|
| `#35` | AH-530 adaptation readiness PR; merge-ready after required checks pass | none |
