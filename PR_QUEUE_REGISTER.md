...
|---|---|---|---|---|---|---|---|---|
| `#38` | `AH-531` / `AH-532` | `RUN-pattern-implementation-ah531-ah532-20260525` | `agenthub/pattern-implementation-ah531-ah532-20260525` | T0 Registrar | `MERGE_READY` | Implements AgentHub-local external pattern controls: skill-pack/command/connector separation, eval/context-health/token-loop/skill-discovery checks, and pattern adaptation runbook. No external runtime install or code import. | PR `#38`; `governance/agenthub-skill-pack-command-connector-patterns.md`; `governance/agenthub-eval-context-health-patterns.md`; `runbooks/agenthub-pattern-adaptation-control-loop.md`; `reports/receipts/AH-531-AH-532-pattern-implementation-receipt.md` | none |
| `#37` | `AH-533` | `RUN-control-spine-git-route-policy-20260525` | `agenthub/git-route-policy-20260525` | T0 Registrar | `MERGE_READY` | Adds explicit AGENTS.md rule that Git/GitHub mutation for control-spine must be YouTrack-task-bound and AgentHub-routed with RUN_ID, branch, evidence, validation, and receipt. | PR `#37`; `AGENTS.md`; `reports/receipts/AH-533-git-route-policy-receipt.md` | none |
...
| PR | Decision | Blocker |
|---|---|---|
| `#38` | Merge-ready governance-only PR for AH-531/AH-532 pattern implementation controls. | none |
| `#37` | Merge-ready governance-only PR for AH-533 Git/GitHub route policy. | none |
