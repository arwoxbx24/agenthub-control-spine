...
|---|---|---|---|---|---|---|---|---|
| `#45` | `AH-542` | `RUN-agenthub-p0-paralysis-breaker-repo-first-control-repair-20260525` | `agenthub/ah542-paralysis-breaker-controls-20260525` | T1 Architecture Broker / T0 Registrar | `READY_TO_MERGE` | Install lane router, blocker taxonomy, paralysis breaker runbook, task graph closure, repo-first lifecycle controls, active skill docs, eval fixtures, registers, and receipt. No runtime/Docker/DB/Nginx/proxy mutation. | PR `#45`; head commit updated by AH-542 registrar; receipt `reports/receipts/RUN-agenthub-p0-paralysis-breaker-repo-first-control-repair-20260525-receipt.md`; task `AH-542`; GitHub/YouTrack/AgentHub evidence accepted as fallback when `agent_share` is unavailable. | none for lanes A/B/C; lane F MinIO transport failure is scoped and non-global |
| `#44` | `AH-541` | `RUN-agenthub-openai-cyber-flag-safe-router-20260525` | `agenthub/openai-cyber-safe-router-20260525` | T1 Architecture Broker / T0 Registrar | `OPEN` | Install four-class OpenAI cyber-safe request router, safe normalizer, dispatch templates, schema, evals, register coverage, and receipt. No runtime/Docker/DB/Nginx/proxy mutation. | PR `#44`; commit `857a29aac8a9630237c4bd456fc2acd494731094`; `governance/openai-cyber-safe-request-router.md`; `.agents/skills/agenthub-openai-cyber-safe-request-router/SKILL.md`; `reports/receipts/RUN-agenthub-openai-cyber-flag-safe-router-20260525-openai-cyber-safe-router-receipt.md` | Artifact share blocked: `BLOCKED: MinIO unavailable via localhost and remote endpoint`; not a router implementation blocker. |
...
| PR | Decision | Blocker |
|---|---|---|
| `#45` | AH-542 PR ready to merge; lane F evidence transport failure is scoped and has GitHub/YouTrack/AgentHub fallback evidence. | none for merge |
