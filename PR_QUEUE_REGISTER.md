...
|---|---|---|---|---|---|---|---|---|
| `#24` | `AH-522` / `AH-523` | `RUN-teamlead-control-spine-system-inventory-20260524`; `RUN-teamlead-control-spine-registrar-20260524` | `agenthub/teamlead-control-spine-system-inventory-20260524` | T0 Registrar | `REVIEW_ROUTE_REQUIRED` | Amended as the single current registrar/lifecycle PR; normal merge, safe admin merge, direct protected push, and reviewer-route discovery were attempted. GitHub branch protection still requires an external non-author approving write-access review. | `ARTIFACT_REGISTER.md`; `PR_QUEUE_REGISTER.md`; `reports/receipts/control-spine-pr-queue-cleanup-receipt-20260524.md` | `EXTERNAL_GITHUB_REVIEW_GATE` |
...
| PR | Decision | Blocker |
|---|---|---|
| `#24` | current registrar PR, merge-ready; normal/admin/direct-push merge routes blocked by required review and no non-author reviewer route exposed | `EXTERNAL_GITHUB_REVIEW_GATE` |
