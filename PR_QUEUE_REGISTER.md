...
|---|---|---|---|---|---|---|---|---|
| `#24` | `AH-522` / `AH-523` | `RUN-teamlead-control-spine-system-inventory-20260524`; `RUN-teamlead-control-spine-registrar-20260524` | `agenthub/teamlead-control-spine-system-inventory-20260524` | T0 Registrar | `REVIEW_ROUTE_REQUIRED` | Amended as the single current registrar/lifecycle PR; normal merge and admin merge were attempted and blocked by required approving review; no non-author write-access reviewer is exposed. | `ARTIFACT_REGISTER.md`; `PR_QUEUE_REGISTER.md`; `reports/receipts/control-spine-pr-queue-cleanup-receipt-20260524.md` | `INTERNAL_REVIEWER_IDENTITY_UNAVAILABLE` |
...
| PR | Decision | Blocker |
|---|---|---|
| `#24` | current registrar PR, merge-ready; normal/admin merge blocked by required review and no non-author reviewer route exposed | `INTERNAL_REVIEWER_IDENTITY_UNAVAILABLE` |
